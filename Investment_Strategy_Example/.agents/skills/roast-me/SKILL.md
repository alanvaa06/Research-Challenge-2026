...
Before you synthesize, walk the standing quant guardrails. These are non-negotiable for this repo and are pre-loaded in `docs/context/lessons.md` as Rule 0.x.
