...
| `content_liquidity_weighted_trend.json` | A fully populated `content.json` that, when fed to either build script, reproduces the Strategy Blueprint above. Use it as a worked reference when filling in a new strategy's content. |
...
3. Run the build script(s) from your working directory pointing at your new file.
